...
const API_KEY = "AIzaSyC6Lz3gr0TT3lt16_qFqfds_fa-ta7f6Lk";
const API_URL=:
  ...
  const generateResponse = async(botMsgDiv)=>{
    ...
    try{
     ...
     chatHistory.push({ role:"model", parts:[{ text: responseText}] });
        ...
        textElement.textContent =error.name === "AbortError" ? "Thik he nhi bata raha." : error.message;
        botMsgDiv.classList.remove("loading");
        document.body.classList.remove("bot-responding");
...
const handleFormSubmit = (e) => {
   ...
   const userMessage = promptInput.value.trim();
    ...
    const userMsgDiv=createMsgElement(userMsgHTML,"user-messeges");
    ...
    setTimeout(() => {
        ...
        const botMsgDiv=createMsgElement(botMsgHTML,"bot-messeges","loading");
...
fileInput.addEventListener("change", () => {
    ...
    document.querySelector("#stop-response-btn").addEventListener("click", () =>{
        ...
        clearInterval(typingInterval);
        botMsgDiv.classList.remove("loading");
       chatsContainer.querySelector(".bot-message.loading").classList.remove("bot-responding");
    })
